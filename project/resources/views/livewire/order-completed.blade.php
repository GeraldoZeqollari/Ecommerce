    <div>
        <div class="flex lg:pl-96 sm:pl-40 lg:pt-28 sm:pt-12">
        ...
        <div class="flex flex-col items-center gap-6">
            ...
            <button class="shop_button lg:h-14 lg:w-52 sm:h-10 sm:w-36">Continue Shopping</button>
        </div>

        <div class="flex flex-col items-end lg:pr-96 sm:pr-40 lg:pt-20 sm:pt-12">
