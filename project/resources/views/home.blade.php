...
<body>
    ...
    <div class="color lg:pl-16 flex">
      ...
      <div class="lg:pt-48">
        ...
        <h1 class="text-5xl lg:pt-3">New Furniture Collection Trends in 2020</h1>
    ...
    <div class="lg:pl-96 lg:pb-32 flex lg:gap-4">
    ...
    <div class="flex lg:pl-96 lg:gap-7">
    ...
    <div class="flex lg:pl-96 lg:pt-12 lg:gap-7">
      <div>
   ...
   <div class="flex items-center lg:pl-96 lg:pt-12 lg:gap-10 lg:pb-44">
   ...
   <div class="flex lg:pt-20 lg:pl-96 lg:gap-12 lg:pb-24">
