...
<body>
    ...
    <div class="flex flex-inline justify-center lg:gap-6  lg:py-28">
    ...
    <div class="lg:pb-32 flex flex-wrap justify-center lg:gap-4">
    ...
    <div class="about_div flex flex-col items-center lg:mb-96">
        <div class="lg:pt-12">
